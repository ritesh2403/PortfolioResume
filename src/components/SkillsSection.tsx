...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Multitenant SaaS", level: 95 },
  ...
  },
  {
    ...
    skills: [
      { name: "MySQL", level: 90 },
      { name: "Azure SQL Hyperscale", level: 85 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Loki", level: 75 },
      { name: "PCI-DSS Compliance", level: 85 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Team Leadership (20+)", level: 90 },
      { name: "Stakeholder Mgmt", level: 85 },
      { name: "Product Roadmap", level: 85 },
      { name: "Technical Mentorship", level: 85 },
      { name: "Client Discovery", level: 80 },
    ],
  },
];
